...
export default function Register() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		if (password != confirmPassword) {
			setError("confirm pwd and pwd don't match! you idiot");
			return;
		}
		...
		try {
			...
			console.log(data);
			navigate(`/dashboard/${data.namespace_id}`)
		} catch (err) {
				...
				<table width="500" cellPadding="15" cellSpacing="0" border={2} className="bg-white border-black mt-12">
					<tbody>
						<tr className="bg-[#000080]">
							<td>
								<center>
									<span className="text-white text-2xl">🏴‍☠️ Join KubePirate</span>
								</center>
							</td>
						</tr>
						<tr>
											...
											<tr>
												<td colSpan={2}>
													<p className="mb-4 font-bold text-center">
														Create your account to start orchestrating microservices.
													</p>
												</td>
											</tr>
											<tr>
